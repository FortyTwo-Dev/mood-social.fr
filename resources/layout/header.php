<header class="relative z-30">
    <nav class="w-screen fixed bg-ms-white dark:bg-ms-black transition-all p-5 border-b border-ms-<?=$color[$i]['color']?>">
    ...
    <div id="toggle-theme-button" class="fixed right-0 top-0 mr-8">
