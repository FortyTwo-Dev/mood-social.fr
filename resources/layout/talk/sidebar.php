<nav class="w-min flex items-start justify-start">
    <ul class="w-full mt-6 flex flex-col max-md:pl-4 gap-6">
        ...
        <li class="w-full py-2 md:px-8 text-3xl font-semibold hover:underline">
            <a href="/talk/event/" class="flex items-center gap-4">
                ...
                <p class="max-md:hidden">Évènement</p>
            </a>
        </li>
        <li class="w-full py-2 md:px-8 text-3xl font-semibold hover:underline">
        ...
        <!-- <li class="w-full py-2 md:px-8 text-3xl font-semibold hover:underline">
            <a href="/talk/feed/" class="flex items-center gap-4">
                ...
                <p class="max-md:hidden">J'aime</p>
            </a>
        </li> -->
        <li class="w-full py-2 md:px-8 text-3xl font-semibold hover:underline">
            <a href="/account/show/" target="_blank" class="flex items-center gap-4">
                ...
                <p class="max-md:hidden cursor-pointer">Paramètre</p>
            </a>
        </li>
        <li class="w-full py-2 md:px-8 text-3xl font-semibold hover:underline">
        ...
        <?php if ($_SERVER['REQUEST_URI'] == '/talk/feed/'): ?>
            <li class="w-full py-2 md:px-8 text-xl font-semibold max-md:hidden">
                <button id="button-post" type="button" class="flex rounded-md hover:underline w-full py-2 items-center justify-center gap-4 bg-ms-<?=$mood['color']?> text-ms-<?=$mood['text_color']?> cursor-pointer">Partage ton humeur
                </button>
            </li>
        <?php endif ?>
        <?php if ($_SERVER['REQUEST_URI'] == '/talk/event/'): ?>
            <li class="w-full py-2 md:px-8 text-xl font-semibold max-md:hidden">
                <button id="button-event" type="button" class="flex rounded-md hover:underline w-full py-2 items-center justify-center gap-4 bg-ms-<?=$mood['color']?> text-ms-<?=$mood['text_color']?> cursor-pointer">Créer un évènement
                </button>
            </li>
        <?php endif ?>
    </ul>
