...
function Register() {
    ...
    $stmt->bindValue(':email_verification_expiration', date('Y-m-d H:i:s', strtotime('+1 hour')),PDO::PARAM_INT);
    ...
    $url = GenerateSignedRoute($token, $_SERVER['HTTP_HOST'] . '/auth/verify-email/?userid=' . $user['id'] . '&');
    ...
    SendEmail('test@exemple.com', 'MoodSocial',$request['email'] , 'New account', $body);
