...
<body class="relative">
    ...
    <main class="flex flex-col justify-center items-center gap-6 h-svh">
        ...
        <div class="max-w-lg w-full flex flex-col gap-4">
            ...
            <div class="border border-ms-grey/50 px-8 py-2 rounded-md focus-within:border-ms-grey">
        ...
        <button class="max-w-lg w-full py-2 bg-ms-grey rounded-md hover:underline text-ms-white">Se connecter</button>
